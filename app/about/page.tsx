    ...
    <main className="bg-white">
      <div className="pt-24 pb-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-5xl font-bold text-[#001a4d] mb-6 text-balance">About AR Energy</h1>
          <p className="text-xl text-gray-600 mb-12 max-w-3xl">
            For 10 years, AR Energy has been leading the solar revolution, helping thousands of homes and businesses
