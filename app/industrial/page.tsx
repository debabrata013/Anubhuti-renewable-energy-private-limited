    ...
    <main className="bg-white">
      <div className="pt-24 pb-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <Link
            href="/signup"
            className="inline-block bg-[#00d4ff] text-[#001a4d] px-8 py-3 rounded-lg font-semibold hover:bg-[#001a4d] hover:text-[#00d4ff] transition-colors hover:scale-105 transform duration-200"
          >
          ...
          <div className="mt-16 grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={idx} className="bg-gray-50 p-8 rounded-lg border-2 border-[#00d4ff] hover:shadow-xl transition-all duration-300 hover:-translate-y-2 hover:bg-white">
