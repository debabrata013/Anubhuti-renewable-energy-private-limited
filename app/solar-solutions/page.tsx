        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="scroll-fade-in-left">
              ...
              <button className="bg-[#2d7a4a] text-white px-8 py-3 rounded-lg hover:bg-[#0099cc] transition-colors font-semibold hover:scale-105 transform duration-200">
                Learn More
              </button>
            </div>
            <div className="scroll-fade-in-right">
              <div className="bg-gradient-to-br from-[#e8f5f0] to-[#d0ebe0] rounded-lg p-8 h-96 flex items-center justify-center hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="scroll-fade-in">
              <div className="bg-gradient-to-br from-[#2d7a4a] to-[#0099cc] rounded-lg p-8 h-96 flex items-center justify-center hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
                <div className="text-center">
            ...
            <div className="scroll-fade-in">
              ...
              <button className="bg-[#0099cc] text-white px-8 py-3 rounded-lg hover:bg-[#2d7a4a] transition-colors font-semibold hover:scale-105 transform duration-200">
                Explore Storage
              </button>
            </div>
          </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div
                key={index}
                className="scroll-fade-in bg-[#f0f9f6] p-8 rounded-lg border border-[#d0ebe0] hover:shadow-xl transition-all duration-300 hover:-translate-y-2 hover:border-[#2d7a4a]"
              >
