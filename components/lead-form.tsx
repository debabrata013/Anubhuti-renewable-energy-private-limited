        ...
        <div className="bg-white rounded-2xl p-8 shadow-2xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="grid grid-cols-2 gap-2">
                {billRanges.map((range) => (
                  <button
                    ...
                    className={`px-3 py-2 rounded-lg text-sm font-medium transition-all ${formData.billRange === range
              ...
              <div className="grid grid-cols-2 gap-2">
                {roofAreas.map((area) => (
                  <button
                    ...
                    className={`px-3 py-2 rounded-lg text-sm font-medium transition-all ${formData.roofArea === area
                      ? "bg-[#0d5f3f] text-white"
                      : "bg-gray-100 text-gray-900 hover:bg-gray-200"
                      }`}
                  >
            ...
            <label className="flex items-start gap-3 text-sm text-gray-700">
              ...
              />
              <span>
                I agree to AR Energy&apos;s <span className="font-semibold">terms of service</span> &{" "}
